...
if __name__ == "__main__":
    ...
    list_file_path = "/root/workplace/SDD-FIQA/generate_pseudo_labels/feature_list"  # 替换为你的 list 文件路径
    npy_file_path = "/root/workplace/SDD-FIQA/generate_pseudo_labels/npy/npy.npy"  # 替换为你想保存的 npy 文件路径
